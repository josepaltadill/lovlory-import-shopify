...
- [~] **SHP-021 — Definir embalaje discreto** y verificar que etiqueta, remitente y descriptor respeten la política de privacidad de marca. Lorena confirma embalaje sin logotipos y remitente discreto. Revisado el 28/07/2026 `Documentos > Nombre del remitente en las etiquetas de envío`: está seleccionada la opción `Lovlory`; el campo alternativo `Nombre personalizado` está vacío y admite hasta 25 caracteres. Falta que Lorena confirme si `Lovlory` es suficientemente discreto o facilite el texto genérico exacto. No se cambió la selección ni se guardó.
