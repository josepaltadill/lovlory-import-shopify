...
INPUT = BASE / "datos" / "02-datos-intermedios" / "wc-product-export-29-6-2026-marcas-mvp.csv"
OUTPUT = BASE / "datos" / "02-datos-intermedios" / "wc-product-export-29-6-2026-marcas-mvp_limpio.csv"
REPORT = BASE / "datos" / "05-informes-validacion" / "wc-product-export-29-6-2026-marcas-mvp_limpieza_resumen.json"
